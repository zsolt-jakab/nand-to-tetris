...
func Test_Compilation_Engine_Square_Main(t *testing.T) {
	...
	var tokenizer analyzer.Tokenizer = tokenizer.NewJackTokenizer(sourceCode)
	var compilationEngine analyzer.CompilationEngine = NewJackCompilationEngine(&tokenizer)
